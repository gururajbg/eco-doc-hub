...
import { FileText, Battery, ShieldCheck, Leaf } from "lucide-react";
      ...
      <div className="flex-grow bg-gradient-to-b from-eco-paper to-white dark:from-eco-green-dark dark:to-eco-green-medium">
        <div className="eco-container">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between py-12 md:py-20">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/e-waste" className="inline-flex items-center bg-eco-green-medium hover:bg-eco-green-dark text-white px-6 py-3 rounded-lg shadow-md transition-colors">
                  <ShieldCheck className="mr-2 h-5 w-5" />
                  E-Waste Resources
                </Link>
                <Link to="/battery-rules" className="inline-flex items-center bg-eco-blue-dark hover:bg-eco-blue-light text-white px-6 py-3 rounded-lg shadow-md transition-colors">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="relative w-64 h-64 md:w-80 md:h-80">
                ...
                <Leaf className="absolute inset-0 m-auto h-40 w-40 md:h-56 md:w-56 text-eco-green-dark dark:text-eco-green-light" />
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 py-12">
            <div className="bg-white dark:bg-eco-green-dark rounded-lg p-6 shadow-md">
              ...
              <Link to="/e-waste" className="text-eco-green-medium dark:text-eco-green-light font-medium hover:underline flex items-center">
            ...
            <div className="bg-white dark:bg-eco-green-dark rounded-lg p-6 shadow-md">
              ...
              <Link to="/battery-rules" className="text-eco-blue-dark dark:text-eco-blue-light font-medium hover:underline flex items-center">
                <span>View documents</span>
                <svg className="ml-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
