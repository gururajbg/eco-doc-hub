      ...
      <div className="flex-grow bg-gray-50 dark:bg-eco-green-medium/10">
        <div className="eco-container">
          <div className="flex items-center mb-8">
            <Settings className="h-10 w-10 mr-3 text-gray-700 dark:text-gray-200" />
              ...
              <div className="bg-white dark:bg-eco-green-dark rounded-lg shadow-md p-6">
                ...
                <div className="mb-8">
                  <div className="flex items-center mb-4">
                    <Archive className="h-5 w-5 mr-2 text-eco-green-medium dark:text-eco-green-light" />
                  ...
                  <div className="space-y-3">
                    {eWasteDocuments.length > 0 ? (
                      eWasteDocuments.map((doc) => (
                        <PdfCard key={doc.id} document={doc} showDelete={true} />
                      ))
                    ) : (
                ...
                <div>
                  <div className="flex items-center mb-4">
                    <Archive className="h-5 w-5 mr-2 text-eco-blue-dark dark:text-eco-blue-light" />
                    <h3 className="text-lg font-medium text-eco-green-dark dark:text-white">
