...
const PdfCard: React.FC<PdfCardProps> = ({ document, showDelete = false }) => {
  ...
  return (
    <a
      ...
      className="block bg-white dark:bg-eco-green-dark border border-gray-200 dark:border-eco-green-medium rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow"
    >
      <div className="p-4 flex items-start">
        <div className="mr-3 mt-1">
          <FileText className="h-8 w-8 text-eco-blue-dark" />
        </div>
        <div className="flex-grow">
          ...
          <div className="flex justify-between items-center mt-2">
            ...
            <div className="flex items-center space-x-2">
              <Download className="h-4 w-4 text-eco-blue-dark dark:text-eco-blue-light" />
              {showDelete && (
                <button 
